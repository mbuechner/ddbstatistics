...
public class DDBPiechartSector {
    ...
    private final static String API = "https://api.deutsche-digitale-bibliothek.de/2/search/index/search/select?q=*:*&rows=0&facet=on&facet.field=sector_fct&facet.mincount=1&faet.limit=-1";
