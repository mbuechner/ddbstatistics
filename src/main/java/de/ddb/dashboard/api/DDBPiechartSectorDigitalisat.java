...
@RequestMapping("api")
@Slf4j
public class DDBPiechartSectorDigitalisat {

    private final static String API = "https://api.deutsche-digitale-bibliothek.de/search/index/search/select?q=digitalisat:true&rows=0&facet=on&facet.field=sector_fct&facet.mincount=1&facet.limit=-1&oauth_consumer_key=";
