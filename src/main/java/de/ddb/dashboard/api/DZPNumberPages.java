...
public class DZPNumberPages {
    ...
    private final static String API = "https://api.deutsche-digitale-bibliothek.de/2/search/index/newspaper-issues/select?q=type:page&rows=0";
    private final static String API_WITH_ZDB_ID = "https://api.deutsche-digitale-bibliothek.de/2/search/index/newspaper-issues/select?q=type:page AND zdb_id:{{zdb_id}}&rows=0";
    ...
    @CacheEvict(value = "dzp-number-pages", allEntries = true)
